...
def xml_to_json(xml_path, json_path):
    ...
    json_data["annotations"].append({
        ...
        "segmentation": [
            [
                int(root.find(".//object/bndbox/x0").text),
                int(root.find(".//object/bndbox/y0").text),
                int(root.find(".//object/bndbox/x1").text),
                int(root.find(".//object/bndbox/y1").text),
                int(root.find(".//object/bndbox/x2").text),
                int(root.find(".//object/bndbox/y2").text),
                int(root.find(".//object/bndbox/x3").text),
                int(root.find(".//object/bndbox/y3").text),
            ]
        ],
        "keypoints": [
            int(root.find(".//object/bndbox/x0").text),
