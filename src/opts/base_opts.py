...
class Opts:
    ...
    def init(self):
        ...
        self.parser.add_argument('-datatrain', default='output', help='Training data folder')
        self.parser.add_argument('-dataval', default='output', help='validation  data folder')
        self.parser.add_argument('-nThreads', default=8, type=int, help='Number of threads')
        ...
        self.parser.add_argument('-train',default=True, dest='train', action='store_true', help='Train')
